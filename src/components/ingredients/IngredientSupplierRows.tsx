  ...
  if (isLoading) {
    return (
      <tr className="border-b border-border bg-surface-muted/50">
        <td colSpan={6} className="px-4 py-3 pl-12 text-sm text-fg-muted">
          Loading suppliers…
        </td>
      </tr>
    )
                ...
                {sorted.map((p) => {
                  ...
                  return (
                    <tr
                      key={p.id}
                      className={
                        isCheapest ? 'bg-accent-muted/50' : undefined
                      }
                    >
                      <td className="py-2 pr-3">
                        <span className="font-medium">{p.vendor_name}</span>
                        {isCheapest && (
                          <span className="ml-2 text-xs text-accent">Best price</span>
                        )}
                      </td>
                      ...
                      <td className="py-2 pr-3 text-right font-medium text-accent">
